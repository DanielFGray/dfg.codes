...
tags: [vim, unfinished]
date: '2017-02-02'
description: getting started with vim
---
...
<center>
  [![http://www.catonmat.net/blog/why-vim-uses-hjkl-as-arrow-keys/](http://www.catonmat.net/images/why-vim-uses-hjkl/adm-3a-hjkl-keyboard.jpg
  "from the ADM-3A")](http://www.catonmat.net/blog/why-vim-uses-hjkl-as-arrow-keys/)
</center>
