---
title: Setting Up A Webpack Toolchain
category: computers
...
> **This article is outdated.** The tooling covered here (Webpack, Babel, etc.) has been largely superseded. See the [updated version](/articles/vite-toolchain) which covers Vite, Rolldown, tsgo, and oxc.
