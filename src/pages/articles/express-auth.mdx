...
export const meta = {
  title: 'Authentication and Authorization using Postgres and Express',
  category: 'computers',
...
<Callout>
<Callout.Title>how do cookie sessions work?</Callout.Title>
...
```js scripts/generate-dotenv.mjs
// @ts-check
...
```json package.json bg=3:8 focus=3:8 mark=7[61:76]
{
  "scripts": {
