...
<CH.Spotlight className="horizontal" rows={40}>
```javascript
export function ExampleForm() {
  return (
    <form
...
export const validationFormExampleStyle = `
body {
  font-family: sans;
}
...
<div className="full-bleed not-prose">
<EditorWithPreview
  template="react"
  options={{
    editorHeight: '80dvh',
  ...
  files={{
    ...
    '/styles.css': { code: validationFormExampleStyle, hidden: true },
  }}
/>
</div>
